...
# inotifywait watches for file system events
while true; do
    ...
    if [ ${#watch_paths[@]} -gt 0 ]; then
        # Wait for any file system event (modify, create, delete, move)
